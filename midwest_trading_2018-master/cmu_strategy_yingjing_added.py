...
class SampleStrategy(PortfolioGenerator):
    ...
    def __init__(self):
        ...
        # chenged to pre loaded from rank by James
        self.stock_indices = select_stocks_from_industry(0.3)
        print(self.stock_indices)
    ...
    def build_signal(self, stock_features):
        ...
        if self.to_use_MCA==True:
            ...
            # print("Selected ticker df", selected_ticker_df[-1,:])
